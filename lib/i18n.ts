...
const dict: Record<TranslationKeys, Record<Lang, string>> = {
  ...
  // AI Assistant
  "ai.title": { he: 'קואורדינטה · המדריכה החכמה', en: "Coordinata · Smart Guide", fr: "Coordinata · Assistant", es: "Coordinata · Guía", ru: "Координата · помощник", ar: "كوأورديناطا · المرشدة" },
  "ai.online": { he: 'זמינה לעזור', en: "Here to help", fr: "En ligne", es: "En línea", ru: "В сети", ar: "متصلة" },
  "ai.intro": { he: 'שלום, אני קואורדינטה 🧭 המדריכה החכמה של מפ"י. אני אלווה אתכם שלב-אחר-שלב בכל פעולה בפורטל — הזמנת מפה, מנוי CORS, כניסה לאזור האישי ועוד. בחרו מדריך מהיר למטה, או כתבו לי מה תרצו לעשות.', en: "Hi, I'm Coordinata 🧭, MAPI's smart guide. I'll walk you step-by-step through any portal action — ordering a map, CORS subscription, signing in, and more. Pick a quick guide below or tell me what you'd like to do.", fr: "Bonjour, je suis Coordinata 🧭, votre guide.", es: "Hola, soy Coordinata 🧭, tu guía.", ru: "Привет, я Координата 🧭, ваш гид.", ar: "مرحبا، أنا كوأورديناطا 🧭، مرشدتكم." },
  ...
  "of.areaHint": { he: 'סמנו את האזור הגיאוגרפי על המפה באמצעות כלי הפוליגון. המידות המדויקות ייקבעו על ידי מפ"י מהאזור שסימנתם.', en: 'Mark the geographic area on the map with the polygon tool. Exact dimensions are determined by MAPI from your marked area.', fr: 'Marquez la zone avec l\'outil polygone. Dimensions définies par MAPI.', es: 'Marca el área con la herramienta de polígono. MAPI determina las dimensiones.', ru: 'Отметьте область инструментом полигона. Точные размеры определяет MAPI.', ar: 'حددوا المنطقة بأداة المضلع. تحدد مفي الأبعاد الدقيقة.' },
  ...
  "nav.tip.home": { he: 'עמוד הבית של הפורטל. כאן תמצאו את המוצרים המומלצים, ניווט לפי קטגוריות ומפת GovMap אינטראקטיבית. נקודת ההתחלה לכל פעולה בפורטל.', en: 'Portal home. Featured products, category navigation and an interactive GovMap. The starting point for any action.', fr: 'Accueil du portail — produits phares, catégories et carte interactive.', es: 'Inicio del portal — productos destacados, categorías y mapa interactivo.', ru: 'Главная портала — рекомендуемые продукты, категории и интерактивная карта.', ar: 'الصفحة الرئيسية — منتجات مميزة وفئات وخريطة تفاعلية.' },
  "nav.tip.catalog": { he: 'קטלוג השירותים המלא של מפ"י. עיינו במפות, נתוני קדסטר, שירותי גיאודזיה ותצלומי אוויר, סננו לפי סוג לקוח ומחיר, והזמינו באופן מקוון. לחצו על מוצר לפרטים מלאים ולהתחלת הזמנה.', en: 'MAPI\'s full service catalog. Browse maps, cadastre, geodesy and aerial photos, filter by customer type and price, and order online.', fr: 'Catalogue complet — cartes, cadastre, géodésie et photos aériennes avec commande en ligne.', es: 'Catálogo completo — mapas, catastro, geodesia y fotos aéreas con pedido en línea.', ru: 'Полный каталог — карты, кадастр, геодезия и аэрофотоснимки с онлайн-заказом.', ar: 'الكتالوج الكامل — خرائط ومساحة وجيوديسيا وصور جوية مع طلب إلكتروني.' },
  "nav.tip.bundles": { he: 'חבילות אזוריות משולבות במחיר מוזל. כל חבילה מאגדת אורתופוטו, שכבות GIS ומודלי גובה לאזור נבחר, בהנחה של עד 32% לעומת רכישה נפרדת. מתאים לפרויקטים תכנוניים והנדסיים.', en: 'Bundled regional packages at up to 32% off vs. buying separately — orthophoto, GIS layers and elevation together.', fr: 'Packs régionaux jusqu\'à -32% — orthophoto, SIG et altimétrie ensemble.', es: 'Paquetes regionales con hasta 32% de descuento — ortofoto, SIG y elevación.', ru: 'Региональные пакеты со скидкой до 32% — ортофото, GIS и высоты вместе.', ar: 'حزم إقليمية بخصم يصل إلى 32% — أورثوفوتو وطبقات GIS وارتفاعات معًا.' },
  "nav.tip.plans": { he: 'מסלולי מנוי לגישה מתמשכת. בחרו בין מסלול חינמי, פרימיום (₪300 לחודש) ומגזר ציבורי, עם טבלת השוואת יכולות מלאה. מתאים למשתמשים קבועים ולארגונים.', en: 'Subscription plans for ongoing access — free, premium (₪300/mo) and public sector, with a full feature comparison.', fr: 'Formules d\'abonnement — gratuit, premium et secteur public avec comparaison.', es: 'Planes de suscripción — gratuito, premium y sector público con comparación.', ru: 'Тарифы — бесплатный, премиум и госсектор с полным сравнением.', ar: 'خطط الاشتراك — مجاني ومتميز وقطاع عام مع مقارنة كاملة.' },
  "nav.tip.apiHub": { he: 'מרכז המפתחים — לשימוש טכני בלבד. כאן מקבלים מפתחות API, מנטרים שימוש, וקוראים תיעוד ודוגמאות קוד לחיבור מערכות חיצוניות לשירותי מפ"י.', en: 'Developer hub (technical) — API keys, usage monitoring, docs and code samples for integrating external systems.', fr: 'Espace développeurs — clés API, suivi, documentation et exemples de code.', es: 'Centro de desarrolladores — claves API, monitoreo, documentación y ejemplos.', ru: 'Центр разработчиков — API-ключи, мониторинг, документация и примеры кода.', ar: 'مركز المطورين — مفاتيح API ومراقبة وتوثيق وأمثلة برمجية.' },
  "nav.tip.dashboard": { he: 'האזור האישי שלכם. כאן מרוכזים כל ההזמנות, המנויים הפעילים, הצעות המחיר וקבצים להורדה. הכניסה מחייבת הזדהות לאומית מאובטחת.', en: 'Your personal area — all your orders, active subscriptions, quotes and downloads in one place (secure sign-in required).', fr: 'Espace personnel — commandes, abonnements, devis et téléchargements.', es: 'Área personal — pedidos, suscripciones, presupuestos y descargas.', ru: 'Личный кабинет — заказы, подписки, счета и загрузки.', ar: 'المنطقة الشخصية — طلبات واشتراكات وعروض أسعار وتنزيلات.' },
  "nav.tip.help": { he: 'מרכז העזרה והתמיכה. תמצאו כאן שאלות נפוצות, מדריכים מפורטים, צ\'אט עם קואורדינטה, ופתיחת פנייה לצוות השירות. מענה תוך 2 ימי עסקים.', en: 'Help & support center — FAQ, detailed guides, chat with Coordinata, and support tickets (2-business-day response).', fr: 'Centre d\'aide — FAQ, guides, chat et ouverture de demande.', es: 'Centro de ayuda — preguntas frecuentes, guías, chat y tickets.', ru: 'Центр помощи — FAQ, руководства, чат и обращения в поддержку.', ar: 'مركز المساعدة — أسئلة شائعة وأدلة ودردشة وطلبات دعم.' },
