...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: "maps",
    categoryLabel: "מפות והדפסות",
    shortDescription: 'מפה טופוגרפית מודפסת בקנ"מ 1:25,000 או 1:50,000',
    description: 'מפות טופוגרפיות רשמיות של מפ"י בקנה מידה 1:25,000 ו-1:50,000 — קווי גובה, שבילים, יישובים ותשתיות. מוצר מדף המופק לפי הזמנה.',
    icon: "terrain",
    priceFrom: 90, priceTo: 180, priceUnit: "₪",
    deliveryDays: "5-7 ימי עסקים",
    customerTypes: ["private", "business", "government", "surveyor"],
    highlight: true, inScope: true,
    features: ['קנ"מ 1:25,000 ו-1:50,000', "קווי גובה ושבילים", "הדפסה איכותית או קובץ"],
    priceTable: [
      { label: '1:50,000 (גיליון)', without: 90 },
      { label: '1:25,000 (גיליון)', without: 130 },
      { label: 'סט אזורי (3 גיליונות)', without: 180 }
    ],
    faq: []
  },
  {
    ...
    category: "maps",
    categoryLabel: "מפות והדפסות",
    shortDescription: 'מפת תיור וטיול בקנ"מ 1:250,000 או 1:450,000',
    description: 'מפות תיור וטיול של מפ"י בקנה מידה 1:250,000 ו-1:450,000 — מסלולי טיול, אתרים ותשתית דרכים, לכלל הארץ ולאזורים נבחרים.',
    icon: "hiking",
    priceFrom: 70, priceTo: 140, priceUnit: "₪",
    deliveryDays: "5-7 ימי עסקים",
    customerTypes: ["private", "business", "government"],
    inScope: true,
    features: ['קנ"מ 1:250,000 ו-1:450,000', "מסלולי טיול ואתרים", "כיסוי ארצי ואזורי"],
    faq: []
  },
  {
    slug: "trail-map",
    ...
    category: "maps",
    categoryLabel: "מפות והדפסות",
    shortDescription: "מפת שבילים מסומנים לאזור נבחר",
    description: 'מפות שבילים מסומנים של מפ"י — שבילי הליכה, אופניים וטיול, כולל סימון צבעים ונקודות עניין.',
    icon: "forest",
    priceFrom: 80, priceTo: 150, priceUnit: "₪",
    deliveryDays: "5-7 ימי עסקים",
    customerTypes: ["private", "business"],
    inScope: true,
    features: ["שבילים מסומנים", "נקודות עניין", "קובץ או הדפסה"],
    faq: []
  },
  {
    slug: "student-map",
    name: 'מפת ארץ ישראל לתלמיד',
    category: "maps",
    categoryLabel: "מפות והדפסות",
    shortDescription: "מפת ארץ ישראל חינוכית לתלמידים",
    description: 'מפת ארץ ישראל לתלמיד — מפה חינוכית מודפסת המיועדת למוסדות חינוך ולתלמידים, בהוצאת מפ"י.',
    icon: "school",
    priceFrom: 25, priceTo: 40, priceUnit: "₪",
    deliveryDays: "5-10 ימי עסקים",
    customerTypes: ["private", "government"],
    inScope: true,
    features: ["מהדורה חינוכית", "מתאים לכיתה", "מחיר מוזל למוסדות"],
    faq: []
  },
  {
    slug: "state-emblems-poster",
    name: 'פוסטר סמלי המדינה',
    category: "maps",
    categoryLabel: "מפות והדפסות",
    shortDescription: "פוסטר רשמי של סמלי מדינת ישראל",
    description: 'פוסטר סמלי המדינה — הדפסה רשמית של סמלי מדינת ישראל, בהוצאת המרכז למיפוי ישראל.',
    icon: "flag",
    priceFrom: 20, priceTo: 35, priceUnit: "₪",
    deliveryDays: "5-10 ימי עסקים",
    customerTypes: ["private", "government"],
    inScope: true,
    features: ["הדפסה רשמית", "איכות ארכיון"],
    faq: []
  },
  {
    slug: "tzr-extension",
    name: 'הארכת תוקף תצ"ר',
    category: "certificates",
    categoryLabel: "תעודות עובד ציבור",
    shortDescription: 'הארכת תוקפה של תכנית לצרכי רישום (תצ"ר)',
    description: 'שירות הארכת תוקפה של תכנית לצרכי רישום (תצ"ר) מול מפ"י, לצורך המשך הליכי רישום במקרקעין.',
    icon: "event_repeat",
    priceFrom: 350, priceTo: 900, priceUnit: "₪",
    deliveryDays: "10-21 ימי עסקים",
    customerTypes: ["surveyor", "business", "government"],
    inScope: true,
    features: ['הארכת תוקף תצ"ר', 'טיפול מול מפ"י', "אסמכתא רשמית"],
    faq: []
  },
  {
    slug: "international-boundaries",
    name: "גבולות בינלאומיים",
    category: "gis",
    categoryLabel: 'נתוני GIS',
  ...
  {
    slug: "national-gazetteer",
    name: "גזטיר נתוני נכסים לאומי",
    category: "gis",
    categoryLabel: 'נתוני GIS',
    shortDescription: "מאגר שמות ונתוני נכסים לאומי (גזטיר)",
    description: 'גזטיר נתוני נכסים לאומי — מאגר שמות מקומות ונתוני נכסים לאומי, לשימוש מערכות GIS וגופים ממשלתיים.',
    icon: "menu_book",
    priceFrom: 950, priceTo: 8000, priceUnit: "₪",
    deliveryDays: "לפי הצעת מחיר",
    customerTypes: ["government", "business"],
    inScope: true,
    features: ["מאגר שמות לאומי", "ממשק לגופים ממשלתיים", "בהצעת מחיר"],
    faq: []
  },
  {
