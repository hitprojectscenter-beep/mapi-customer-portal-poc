...
const GUIDES: Guide[] = [
  {
    ...
    steps: [
      ...
      { text: "2. בכרטיס השירות (או בעמוד המוצר) לחצו \"מעבר להזמנה\" — נפתחת לשונית חדשה עם הטופס הממשלתי הרשמי." },
      { text: "3. מלאו את הטופס הרשמי (govforms) — זהו אותו הטופס שאליו מגיעים מהאתר הקיים של מפ\"י. הפורטל נשאר פתוח ברקע." }
    ]
  },
  {
    id: "cors",
    ...
    steps: [
      ...
      { text: "2. לחצו \"מעבר להזמנה\" — נפתחת לשונית חדשה עם טופס ההרשמה הרשמי (govforms) של שירות ה-CORS." },
      { text: "3. מלאו את הטופס והשלימו את ההרשמה מול מפ\"י; פרטי החיבור יימסרו בהתאם לתהליך הרשמי." }
    ]
  },
  {
    id: "personal-area",
